 ...
 *//*
    ...
    private MeshResult draw(Block[][][] blockList,
        ...
        FloatBuffer vertexPosData = BufferUtils.newFloatBuffer(visibleSideCount * 4 * 3);
        FloatBuffer normalData = BufferUtils.newFloatBuffer(visibleSideCount * 4 * 3);
        FloatBuffer colorData = BufferUtils.newFloatBuffer(visibleSideCount * 4 * (useAlpha ? 2 : 1));
        FloatBuffer idData = BufferUtils.newFloatBuffer(visibleSideCount*4);
