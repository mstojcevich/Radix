...
//        this.batcher = new SpriteBatcher(VoxelGameClient.getInstance().getTextureManager());
//
//        this.font = font;
...
//
//
//            int internalFormat = GL20.GL_RGBA /* TODO was GL_RGBA8 */,
//                    format = GL20.GL_RGBA;
//            IntBuffer textureId =  BufferUtils.newIntBuffer(1);
//            Gdx.gl.glGenTextures(1, textureId);
//            Gdx.gl.glBindTexture(GL20.GL_TEXTURE_2D, textureId.get(0));
//
//
...
//
//            // Gdx.gl.glTexEnvf(GL20.GL_TEXTURE_ENV, GL20.GL_TEXTURE_ENV_MODE, GL20.GL_MODULATE); TODO if font rendering doesn't work it's probably this
//
///*            GLU.gluBuild2DMipmaps(GL20.GL_TEXTURE_2D,
//                    internalFormat,
//                    width,
//                    height,
//                    format,
...
//    public void destroy() {
//        if(this.initialized) {
//            IntBuffer scratch = BufferUtils.newIntBuffer(1);
//            scratch.put(0, fontTextureID);
//            Gdx.gl.glBindTexture(GL20.GL_TEXTURE_2D, 0);
//            Gdx.gl.glDeleteTextures(1, scratch);
