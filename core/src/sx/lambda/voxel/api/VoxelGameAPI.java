    ...
    public void registerBuiltinBlocks() throws BlockRegistrationException {
        try {
            registerBlocks(
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.WATER_ID).setHumanName("Water").setSolid(false).setTransparent(true).setLightPassthrough(true).setTextureLocation("textures/block/water.png").build(),
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.FLOWER_ID).setHumanName("Flower").setTextureLocation("textures/block/flower_tulip_orange.png").setSolid(false).setTransparent(true).setLightPassthrough(true).setBlockRenderer(new FoliageBlockRenderer(BuiltInBlockIds.FLOWER_ID)).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.FLOWER_TWO_ID).setHumanName("Flower").setTextureLocation("textures/block/flower_rose.png").setSolid(false).setTransparent(true).setLightPassthrough(true).setBlockRenderer(new FoliageBlockRenderer(BuiltInBlockIds.FLOWER_TWO_ID)).build(),
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.BROWN_MUSHROOM_ID).setHumanName("Brown Mushroom").setTextureLocation("textures/block/mushroom_brown.png").setTransparent(true).setLightPassthrough(true).setSolid(false).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.RED_MUSHROOM_ID).setHumanName("Red Mushroom").setTextureLocation("textures/block/mushroom_red.png").setTransparent(true).setLightPassthrough(true).setSolid(false).build(),
