    ...
    public void registerBuiltinBlocks() throws BlockRegistrationException {
        try {
            registerBlocks(
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.WATER_ID).setHumanName("Water").setSolid(false).setTranslucent(true).setLightPassthrough(true).setTextureLocation("textures/block/water.png").build(),
