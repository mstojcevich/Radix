    ...
    public void registerBuiltinBlocks() throws BlockRegistrationException {
        try {
            registerBlocks(
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.WATER_ID).setHumanName("Water").setSolid(false).setTransparent(true).setTextureLocation("textures/block/water.png").build(),
                    new BlockBuilder().setID(BuiltInBlockIds.LAVA_STILL_ID).setHumanName("Lava (Still)").setSolid(false).setTextureLocation("textures/block/lava.png").build(),
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.TALL_GRASS_ID).setHumanName("Tall Grass").setTextureLocation("textures/block/shrub.png").setSolid(false).setTransparent(true).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.FLOWER_ID).setHumanName("Flower").setTextureLocation("textures/block/shrub.png").setSolid(false).setTransparent(true).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.FLOWER_TWO_ID).setHumanName("Flower").setTextureLocation("textures/block/shrub.png").setSolid(false).setTransparent(true).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.FLOWER_THREE_ID).setHumanName("Flower").setTextureLocation("textures/block/shrub.png").setSolid(false).setTransparent(true).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.SUGAR_CANE_ID).setHumanName("Sugar Cane").setTextureLocation("textures/block/sugarcane.png").setSolid(false).setTransparent(true).build(),
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.LEAVES_ID).setHumanName("Leaves").setTextureLocation("textures/block/leaves_oak.png").setTransparent(true).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.LEAVES_TWO_ID).setHumanName("Leaves").setTextureLocation("textures/block/leaves_oak.png").setTransparent(true).build(),
                    ...
                    new BlockBuilder().setID(BuiltInBlockIds.BROWN_MUSHROOM_ID).setHumanName("Brown Mushroom").setTextureLocation("textures/block/mushroom_brown.png").setTransparent(true).setSolid(false).build(),
                    new BlockBuilder().setID(BuiltInBlockIds.RED_MUSHROOM_ID).setHumanName("Red Mushroom").setTextureLocation("textures/block/mushroom_red.png").setTransparent(true).setSolid(false).build(),
